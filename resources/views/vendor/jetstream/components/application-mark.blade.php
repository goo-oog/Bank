<svg id="Layer_1" enable-background="new 0 0 510 510" height="40" viewBox="0 0 510 510" width="40"
     xmlns="http://www.w3.org/2000/svg">
    <g id="XMLID_130_">
        <g id="XMLID_516_">
            <path id="XMLID_530_" d="m0 255c0 140.932 114.049 255 255 255l15-255-15-255c-140.932 0-255 114.05-255 255z"
                  fill="#fdbf13"/>
            ...
            <path id="XMLID_524_"
                  ...
                  fill="#ffda40"/>
            <path id="XMLID_517_" d="m255 30v450c124.065 0 225-100.935 225-225s-100.935-225-225-225z" fill="#fdbf13"/>
        </g>
        <path id="XMLID_491_"
